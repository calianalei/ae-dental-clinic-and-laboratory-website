    ...
    <div className="auth-container">
      <Card className="card-container">
        <CardContent className="card-content">
          <div className="image-container"><img src={clinicImage} alt="Dental Clinic" className="image" /></div>
          <div className="form-container">
            ...
            <div className="footer-text">
              <Button onClick={switchToForgotPassword} variant="link">Forgot Password?</Button>
